...
public class SWTExtensions {
     ...
     */
    public <T extends Resource> T[] autoDispose(@SuppressWarnings("unchecked") T... resources) {
        for (T r : resources) {
            autoDispose(r);
        }
        return resources;
     ...
     * @deprecated use {@link #autoDispose(Resource...)} instead.
     */
    public <T extends Resource> T[] autoRelease(@SuppressWarnings("unchecked") T... resources) {
        for (T r : resources) {
            autoDispose(r);
        }
        return resources;
    ...
    public <T extends Resource> void safeDispose(@SuppressWarnings("unchecked") T... resource) {
     ...
     * @param widgets
     */
    public <W extends Widget> void safeDispose(@SuppressWarnings("unchecked") W... widgets) {
        for (Widget w : widgets) {
            safeDispose(w);
        }
    }
